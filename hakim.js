...
/*  document.getElementById("first-name").innerHTML = firstName;
  ...
  document.getElementById("user-id").innerHTML = id;
  document.getElementById("department").innerHTML = firstName;
...
async function getDataForModules(){
  const id =[];
  const firstName =[];
  const lastName =[];
  const cycle =[];
  ...
  return {id // , firstName , lastName , cycle , speciality , year
